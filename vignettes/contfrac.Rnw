...
\Plaintitle{Continued fractions in \proglang{R}: introducing the \pkg{contfrac} package}
...
\begin{center}
\includegraphics[width=1in]{\Sexpr{system.file("help/figures/contfrac.png",package="contfrac")}}
\end{center}
\end{wrapfigure}
